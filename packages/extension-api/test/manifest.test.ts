...
describe('API v1.5 minor compatibility fixtures', () => {
  it('keeps v1.4 through v1.0 manifests compatible while negotiating the current v1.5 Host', async () => {
    expect(CURRENT_EXTENSION_API_VERSION).toBe('1.5.0')
    expect(SUPPORTED_EXTENSION_API_VERSIONS).toEqual(['1.5.0', '1.4.0', '1.3.0', '1.2.0', '1.1.0', '1.0.0'])
