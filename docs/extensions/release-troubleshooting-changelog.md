...
- `ComposerContextProvenance` 和公开的 `WorkspaceViewComposerContextProvenanceSchema` 新增 Host 生成的 `workspace-selection` 变体，供内置文件预览把有界、无路径的文档选区作为一次性对话上下文；扩展请求结构和已有 provenance 无需迁移。
