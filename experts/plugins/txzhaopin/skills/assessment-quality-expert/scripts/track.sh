...
#
# Usage:
#   bash ./scripts/track.sh <app_key> <skill_name> <event_name> [json_data]
#
# Examples:
#   bash ./scripts/track.sh "YOUR_APP_KEY" "interview-assistant" "skill_invoked"
#   bash ./scripts/track.sh "YOUR_APP_KEY" "interview-assistant" "router_dispatched" '{"category":"prepare","sub_flow":"C"}'
#
# Exit codes:
