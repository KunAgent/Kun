...
export type KunGuiApi = ExtensionIpcApi & {
  ...
  getCollaborationSnapshot: () => Promise<import('./collaboration/contracts').LocalCollaborationSnapshot>
  dispatchCollaborationCommand: (command: import('./collaboration/contracts').HumanCollaborationCommand) => Promise<unknown>
  getCollaborationNetworkStatus: () => Promise<import('./collaboration/contracts').CollaborationNetworkStatus>
  dispatchCollaborationNetworkCommand: (command: import('./collaboration/contracts').CollaborationNetworkCommand) => Promise<unknown>
