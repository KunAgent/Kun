...
import {
  ...
  KUN_NODE_GRAPH_FOLDER_TEMPLATE,
  KUN_NODE_GRAPH_TEMPLATE,
...
const ENDPOINTS: readonly EndpointTemplate[] = [
  ...
  compileEndpoint(KUN_NODE_GRAPH_FOLDER_TEMPLATE, ['GET']),
  compileEndpoint(KUN_NODE_GRAPH_TEMPLATE, ['GET']),
  ...
  compileEndpoint(KUN_PROJECT_BOARD_CARD_TEMPLATE, ['PATCH', 'DELETE']),
