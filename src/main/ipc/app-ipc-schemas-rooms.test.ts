...
describe('Rooms desktop HTTP boundary', () => {
  it.each([
    ...
    ['/v1/rooms/room-1/topics?limit=50&cursor=topic-50', ['GET']],
    ['/v1/rooms/room-1/topics/topic-1/stop', ['POST']],
    ['/v1/rooms/room-1/topics/topic-1/metrics?limit=200&cursor=metric-1', ['GET']],
    ...
    ['/v1/rooms/room-1/requests/request-1', ['GET']],
    ...['continue', 'cancel', 'reconcile'].map((action) => [`/v1/rooms/room-1/requests/request-1/${action}`, ['POST']]),
    ['/v1/rooms/room-1/tasks?request_id=request-1', ['GET']],
    ['/v1/rooms/room-1/agreements/bundle-1?rule_id=rule-1&version=1', ['GET']],
    ['/v1/rooms/room-1/tasks/task-1/diff?delivery_id=delivery-1&file=source.ts', ['GET']],
    ['/v1/rooms/room-1/tasks/task-1/logs/log-1?cursor=100', ['GET']],
    ['/v1/rooms/room-1/tasks/task-1/reviews?delivery_id=delivery-1', ['GET']],
    ['/v1/rooms/room-1/tasks/task-1/integrations/integration-1', ['GET']],
    ...['diff', 'candidates'].map((part) => [`/v1/rooms/room-1/tasks/task-1/integrations/integration-1/${part}`, ['GET']]),
