...
import {
  ...
  KUN_MEMORY_TEMPLATE,
  KUN_RESEARCH_RUN_APPROVE_TEMPLATE,
  KUN_RESEARCH_RUN_CANCEL_TEMPLATE,
  KUN_RESEARCH_RUN_SCOPE_ANSWER_TEMPLATE,
  KUN_RESEARCH_RUN_SCOPE_CONFIRM_TEMPLATE,
  KUN_RESEARCH_RUNS_TEMPLATE,
  KUN_RESEARCH_RUN_TEMPLATE,
...
const ENDPOINTS: readonly EndpointTemplate[] = [
  ...
  compileEndpoint(KUN_RESEARCH_RUN_APPROVE_TEMPLATE, ['POST']),
  compileEndpoint(KUN_RESEARCH_RUN_CANCEL_TEMPLATE, ['POST']),
