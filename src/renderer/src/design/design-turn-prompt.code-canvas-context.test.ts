...
describe("design turn prompt code canvas and context guidance", () => {
    ...
    it('includes placement guidance for new screen coordinates', () => {
      ...
      expect(prompt).toContain('The project design-system board is a user-draggable file projection')
      expect(prompt).toContain('always keep new content outside its listed rect')
