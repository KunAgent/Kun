...
export function useWorkbenchShellRuntime(context: Context): {
  ...
  const {
    ...
    handlePasteClipboardImage, handlePasteLongText, removeComposerAttachment, restoreComposerAttachments, addComposerFileReference,
  ...
  const chatComposerProps = useWorkbenchChatComposerProps({
    ...
    handlePickAttachments, handlePasteClipboardImage, handlePasteLongText, removeComposerAttachment, restoreComposerAttachments, addComposerFileReference,
