...
export function roomCoordinationPrompt(request: RoomRequestState, history: unknown[], rules: unknown[]): string {
  return [
    'You coordinate a personal Kun room. Return ONE JSON object only. Do not execute tools.',
